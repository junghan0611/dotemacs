...
(defun my/denote-org-dblock-insert-bib-links (regexp)
  ...
  (org-create-dblock (list :name "denote-links"
                           ...
                           :not-regexp nil
                           :excluded-dirs-regexp
                             "\\(meta\\|notes\\|journal\\|posts\\|docs\\|md\\|dict\\|private\\|ekg\\)"
                           :sort-by-component nil
                           :reverse-sort t
                           :id-only nil
                           :include-date t))
...
(defun my/denote-org-dblock-insert-notes-links (regexp)
  ...
  (org-create-dblock (list :name "denote-links"
                           ...
                           :not-regexp nil
                           :excluded-dirs-regexp
                             "\\(meta\\|bib\\|journal\\|posts\\|docs\\|md\\|dict\\|private\\|ekg\\)"
                           :sort-by-component nil
                           :reverse-sort t
                           :id-only nil
                           :include-date t))
...
(defun my/denote-org-dblock-insert-meta-links  ()
  ...
  (let* ((topics (mapcar (lambda (file)
    ...
    (org-create-dblock (list :name "denote-links"
                             ...
                             :not-regexp nil
                             :excluded-dirs-regexp
                             "\\(bib\\|notes\\|elisp\\|docs\\|posts\\|md\\|journal\\|dict\\|private\\|ekg\\)"
                             :sort-by-component nil
                             :reverse-sort t
                             :id-only nil
                             :include-date nil))
